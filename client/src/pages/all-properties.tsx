...
const AllProperties = () => {
  ...
  const currentFilterValues =useMemo(() => {
    ...
    return {
      ...
      propertyType : logicalFilters.find((item) => item.field === 'propertType')?.value || '',
    }
  }, [filters])
    ...
    <Box>
       <Box mt = "20px" sx = {{display: 'flex', flexWrap:'wrap', gap: 3}}>
         <Stack direction = "column" width ="100%">
          <Typography fontSize ={25} fontWeight ={700} color ="#1114ed" >
            
            {!allProperties.length ?'There are no properties' : 'All properties'} All Properties</Typography>
